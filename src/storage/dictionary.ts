...
import { dictionaryRDO, IDictionaryItem, IAddDictionaryPayload } from "../services/rdo/dictionary";
...
const setState = (payload: IDictionaryState) => {
...
export const editItem = async (payload: IAddDictionaryPayload, itemId: string)=> {
    try {
