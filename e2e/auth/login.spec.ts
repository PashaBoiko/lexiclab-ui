...
test.describe('Login flow',  () => {
  ...
  test('Should display validation login form', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="login-email"]').locator('[role="alert"]')).toBeVisible();
    await expect(page.locator('[data-testid="login-password"]').locator('[role="alert"]')).toBeVisible();
  });
